...
copyright = '{% now "utc", "%Y" %}, ' + author  # @ReservedAssignment
pypi_name = '{{cookiecutter.pypi_name}}'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
from {{cookiecutter.pypi_name}} import __version__
...
texinfo_documents = [
    (master_doc, pypi_name, project + ' Documentation',
     author, pypi_name, '{{cookiecutter.description}}',
     'Miscellaneous'),
]
